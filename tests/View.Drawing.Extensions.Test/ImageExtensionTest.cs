...
namespace View.Drawing.Extensions.Test
{
    public class ImageExtensionTest
    {
        ...
        {
            var newMinImgToMin = image24.ChangeSize(minSizeA, new ChangeSizeConfiguration() { Reserve = true, SizeMode = Models.SizeMode.ToMin });
            ...
            var newMinImgToMax = image24.ChangeSize(minSizeA, new ChangeSizeConfiguration() { Reserve = true, SizeMode = Models.SizeMode.ToMax });
            ...
            var newMinImgStretch = image24.ChangeSize(minSizeA, new ChangeSizeConfiguration() { Reserve = true, SizeMode = Models.SizeMode.Stretch });
            ...
            var newMinImgCut1 = image24.ChangeSize(minSizeA, new ChangeSizeConfiguration() { Reserve = true, SizeMode = Models.SizeMode.Cut, Location = new Point(0, 0) });
            ...
            var newMinImgCut2 = image24.ChangeSize(minSizeA, new ChangeSizeConfiguration() { Reserve = true, SizeMode = Models.SizeMode.Cut, Location = new Point(15, 25), ClipInBox = true });
            ...
            var newMinImgCut3 = image24.ChangeSize(minSizeA, new ChangeSizeConfiguration() { Reserve = true, SizeMode = Models.SizeMode.Cut, Location = new Point(15, 25), ClipInBox = false });
