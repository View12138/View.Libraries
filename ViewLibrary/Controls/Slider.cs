    ...
    public partial class Slider : UserControl
    {
        ...
        public int Index
        {
            ...
            set
            {
                ...
                anim.Set(pbButton, Animation.Prop.Left, num3);
                this.DrawImage();
        ...
        private void pbButton_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (flag)
            {
                this.anim.Set(this.label, Animation.Prop.Backcolor, Color.FromArgb(43, 43, 43));
                this.anim.Set(this.label, Animation.Prop.Forecolor, Color.FromArgb(239, 239, 239));
            }
            else
            {
                this.anim.Set(this.label, Animation.Prop.Backcolor, Color.FromArgb(242, 242, 242));
                this.anim.Set(this.label, Animation.Prop.Forecolor, Color.FromArgb(33, 33, 33));
            }
